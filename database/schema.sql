...
CREATE TABLE ESPACIO (
  ...
  CONSTRAINT fk_espacio_dueno
    FOREIGN KEY (fk_id_dueño)
    REFERENCES USUARIO(id_usuario)
) ENGINE=InnoDB;

-- =====================================================================
-- 🤝 3. TABLAS DE COMUNIDAD
-- =====================================================================
...
BEGIN
  ...
  AND (
    (NEW.fecha_inic < fecha_fin)
    AND
    (NEW.fecha_fin > fecha_inic)
  );
...
INSERT INTO USUARIO (
  ...
  'admin@ejemplo.com',
  '$2a$10$JascO//eTcWAb7MMTNJgRO9qVmD6p6KFd6XavR4hTbGJXs/FSKHTm',
  '+123456789',
...
(1, 3, 'Maracaná 5', 'Fútbol 5', 'Av. Principal #450', 'Sintética Premium', 50.00, 'activo', TRUE, '2025-01-01 00:00:00', '2030-12-31 23:59:59'),
(2, 3, 'Camp Nou 7', 'Fútbol 7', 'Av. Principal #450', 'Césped Natural', 70.00, 'activo', TRUE, '2025-01-01 00:00:00', '2030-12-31 23:59:59');

-- LUNES
INSERT INTO EVENTO (id_evento, fk_id_espacio, precio, fecha_inic, fecha_fin, max_jugadores) VALUES
(10, 1, 50.00, '2026-05-04 18:00:00', '2026-05-04 19:00:00', 10);
INSERT INTO PAGO (id_pago, total, metodo, estado, fecha_pago, fk_id_evento) VALUES
(10, 50.00, 'tarjeta', 'pagado', '2026-05-04 17:30:00', 10);

INSERT INTO EVENTO (id_evento, fk_id_espacio, precio, fecha_inic, fecha_fin, max_jugadores) VALUES
(11, 1, 50.00, '2026-05-11 19:00:00', '2026-05-11 20:00:00', 10);
INSERT INTO PAGO (id_pago, total, metodo, estado, fecha_pago, fk_id_evento) VALUES
(11, 50.00, 'efectivo', 'pagado', '2026-05-11 19:00:00', 11);

-- MARTES
INSERT INTO EVENTO (id_evento, fk_id_espacio, precio, fecha_inic, fecha_fin, max_jugadores) VALUES
(20, 1, 50.00, '2026-05-05 20:00:00', '2026-05-05 21:00:00', 10);
INSERT INTO PAGO (id_pago, total, metodo, estado, fecha_pago, fk_id_evento) VALUES
(20, 50.00, 'transferencia', 'pagado', '2026-05-05 19:45:00', 20);

-- MIÉRCOLES
INSERT INTO EVENTO (id_evento, fk_id_espacio, precio, fecha_inic, fecha_fin, max_jugadores) VALUES
(30, 1, 50.00, '2026-05-06 19:00:00', '2026-05-06 20:00:00', 10);
INSERT INTO PAGO (id_pago, total, metodo, estado, fecha_pago, fk_id_evento) VALUES
(30, 50.00, 'tarjeta', 'pagado', '2026-05-06 18:15:00', 30);

INSERT INTO EVENTO (id_evento, fk_id_espacio, precio, fecha_inic, fecha_fin, max_jugadores) VALUES
(31, 1, 50.00, '2026-05-13 21:00:00', '2026-05-13 22:00:00', 10);
INSERT INTO PAGO (id_pago, total, metodo, estado, fecha_pago, fk_id_evento) VALUES
(31, 50.00, 'tarjeta', 'pagado', '2026-05-13 20:50:00', 31);

-- JUEVES
INSERT INTO EVENTO (id_evento, fk_id_espacio, precio, fecha_inic, fecha_fin, max_jugadores) VALUES
(40, 1, 50.00, '2026-05-07 18:00:00', '2026-05-07 20:00:00', 10);
INSERT INTO PAGO (id_pago, total, metodo, estado, fecha_pago, fk_id_evento) VALUES
(40, 100.00, 'transferencia', 'pagado', '2026-05-07 17:00:00', 40);

INSERT INTO EVENTO (id_evento, fk_id_espacio, precio, fecha_inic, fecha_fin, max_jugadores) VALUES
(41, 1, 50.00, '2026-05-14 20:00:00', '2026-05-14 22:00:00', 10);
INSERT INTO PAGO (id_pago, total, metodo, estado, fecha_pago, fk_id_evento) VALUES
(41, 100.00, 'efectivo', 'pagado', '2026-05-14 20:00:00', 41);

-- VIERNES
INSERT INTO EVENTO (id_evento, fk_id_espacio, precio, fecha_inic, fecha_fin, max_jugadores) VALUES
(50, 1, 55.00, '2026-05-01 18:00:00', '2026-05-01 20:00:00', 10);
INSERT INTO PAGO (id_pago, total, metodo, estado, fecha_pago, fk_id_evento) VALUES
(50, 110.00, 'tarjeta', 'pagado', '2026-05-01 15:20:00', 50);

INSERT INTO EVENTO (id_evento, fk_id_espacio, precio, fecha_inic, fecha_fin, max_jugadores) VALUES
(51, 1, 55.00, '2026-05-08 20:00:00', '2026-05-08 22:00:00', 10);
INSERT INTO PAGO (id_pago, total, metodo, estado, fecha_pago, fk_id_evento) VALUES
(51, 110.00, 'transferencia', 'pagado', '2026-05-08 19:10:00', 51);

INSERT INTO EVENTO (id_evento, fk_id_espacio, precio, fecha_inic, fecha_fin, max_jugadores) VALUES
(52, 1, 55.00, '2026-05-15 22:00:00', '2026-05-15 23:00:00', 10);
INSERT INTO PAGO (id_pago, total, metodo, estado, fecha_pago, fk_id_evento) VALUES
(52, 55.00, 'tarjeta', 'pagado', '2026-05-15 21:40:00', 52);

-- SÁBADO
INSERT INTO EVENTO (id_evento, fk_id_espacio, precio, fecha_inic, fecha_fin, max_jugadores) VALUES
(60, 1, 60.00, '2026-05-02 14:00:00', '2026-05-02 16:00:00', 10);
INSERT INTO PAGO (id_pago, total, metodo, estado, fecha_pago, fk_id_evento) VALUES
(60, 120.00, 'tarjeta', 'pagado', '2026-05-02 11:00:00', 60);

INSERT INTO EVENTO (id_evento, fk_id_espacio, precio, fecha_inic, fecha_fin, max_jugadores) VALUES
(61, 1, 65.00, '2026-05-02 17:00:00', '2026-05-02 19:00:00', 10);
INSERT INTO PAGO (id_pago, total, metodo, estado, fecha_pago, fk_id_evento) VALUES
(61, 130.00, 'tarjeta', 'pagado', '2026-05-02 16:45:00', 61);

INSERT INTO EVENTO (id_evento, fk_id_espacio, precio, fecha_inic, fecha_fin, max_jugadores) VALUES
(62, 1, 65.00, '2026-05-09 19:00:00', '2026-05-09 21:00:00', 10);
INSERT INTO PAGO (id_pago, total, metodo, estado, fecha_pago, fk_id_evento) VALUES
(62, 130.00, 'transferencia', 'pagado', '2026-05-08 22:00:00', 62);

-- DOMINGO
INSERT INTO EVENTO (id_evento, fk_id_espacio, precio, fecha_inic, fecha_fin, max_jugadores) VALUES
(70, 1, 50.00, '2026-05-03 10:00:00', '2026-05-03 12:00:00', 10);
INSERT INTO PAGO (id_pago, total, metodo, estado, fecha_pago, fk_id_evento) VALUES
(70, 100.00, 'efectivo', 'pagado', '2026-05-03 12:00:00', 70);

INSERT INTO EVENTO (id_evento, fk_id_espacio, precio, fecha_inic, fecha_fin, max_jugadores) VALUES
(71, 1, 50.00, '2026-05-10 16:00:00', '2026-05-10 18:00:00', 10);
INSERT INTO PAGO (id_pago, total, metodo, estado, fecha_pago, fk_id_evento) VALUES
(71, 100.00, 'tarjeta', 'pagado', '2026-05-10 15:30:00', 71);

-- =====================================================================
-- 🔄 9. ACTUALIZAR RELACIONES CRUZADAS
-- =====================================================================
